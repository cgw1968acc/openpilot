...
A_CRUISE_MIN = -1.2
A_CRUISE_MAX_VALS =   [2.0, 2.0,  1.76, 0.945, .585, .47,  .34,  .12]
A_CRUISE_MAX_BP =     [0.,  6.1,  8.,   11.,   20.,  25.,  30.,  40.]
A_CRUISE_MIN_V =      [-0.01, -0.01, -0.06, -0.06, -0.10, -0.10, -0.24, -0.24, -0.34,  -0.34, -0.55, -1.2]
A_CRUISE_MIN_BP =     [0.,     0.05,  0.06,  8.00,  8.01, 12.,  12.01,  15.,   15.01,  18.,   18.01, 30.]
